...
Creates a new User Account and automatically signs the User in.
        """)
    @ApiResponses(value = [
        ApiResponse(code = 200, message = "Account created successfully", responseHeaders = [
    ...
    fun signUp(@RequestBody @Valid body: EmailPasswordSignUpDTO): ResponseEntity<Void> {
        ...
        val jwtString = jwtHelper.convertUserAccountToJwtString(savedUserAccount, AuthenticationMethod.USERNAME_PASSWORD)
